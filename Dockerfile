...
FROM --platform=$BUILDPLATFORM rust:1.94.1-alpine3.20 as planner
...
FROM --platform=$BUILDPLATFORM rust:1.94.1-alpine3.20 as cacher
...
FROM --platform=$BUILDPLATFORM rust:1.94.1-alpine3.20 as builder

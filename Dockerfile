...
FROM --platform=$BUILDPLATFORM rust:1.97.0-alpine3.23 AS planner
...
FROM --platform=$BUILDPLATFORM rust:1.97.0-alpine3.23 AS cacher
...
FROM --platform=$BUILDPLATFORM rust:1.97.0-alpine3.23 AS builder
